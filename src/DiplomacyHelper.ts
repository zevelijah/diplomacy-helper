  ...
  render() {
    return html`
      ...
      <div id="web">
        ...
        <div id="content">
          ...
          <div id="vdiplomacy" class="content-padding bottom-border">
            ...
            <figure>
              <img src="Vdip.png" alt="VDiplomacy" width="600" height="500" />
              <figcaption class="caption">
                <h5>
          ...
          <div id="redscape" class="content-padding bottom-border">
            ...
            <div class="play-text">
              <p>
                A forum based play by email type ordeal. I don't know much more
                about since I didn't register(I've already registered on
                WebDiplomacy in the<br />name of this website, thank you very
                much), but that shoud be enough to get you started.
              </p>
            </div>
            <figure>
              <img
              ...
              />
              <figcaption class="caption">
                <h5>Redscape Homepage. redscape.com</h5>
              </figcaption>
            </figure>
          </div>
        </div>
      ...
      <div id="Sources">
        ...
        <h2>Sources</h2>
        <p>
          I did not know of all of these websites by myself. My main Importance
          Is gathering everyone's <br />hard work into a concentrated space. Not
          including the sites already mentioned, here are those sites:
        </p>
        <ul>
          <li>
            <a
      ...
      <div id="updated">
        <hr class="line" />
        <p>Last updated on September 30.</p>
      </div>
    `;
  }
}
